 ...
 * on 2016-01-04 at 09:17:54 UTC 
 * Modify at your own risk.
 */

package com.tivra.mh.mhtracker_proto.quoteApi;
...
public class QuoteApi extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
   ...
   * @since 1.7
   */
  public static final String DEFAULT_ROOT_URL = "https://tactile-timer-116208.appspot.com/_ah/api/";
  ...
  public class GetQuote extends QuoteApiRequest<com.tivra.mh.mhtracker_proto.quoteApi.model.Quote> {
    ...
    protected GetQuote(java.lang.Long id) {
      super(QuoteApi.this, "GET", REST_PATH, null, com.tivra.mh.mhtracker_proto.quoteApi.model.Quote.class);
   ...
   *
   * @param content the {@link com.tivra.mh.mhtracker_proto.quoteApi.model.Quote}
   * @return the request
   */
  public InsertQuote insertQuote(com.tivra.mh.mhtracker_proto.quoteApi.model.Quote content) throws java.io.IOException {
    InsertQuote result = new InsertQuote(content);
    initialize(result);
    return result;
  }

  public class InsertQuote extends QuoteApiRequest<com.tivra.mh.mhtracker_proto.quoteApi.model.Quote> {
     ...
     * @since 1.13
     */
    protected InsertQuote(com.tivra.mh.mhtracker_proto.quoteApi.model.Quote content) {
      super(QuoteApi.this, "POST", REST_PATH, content, com.tivra.mh.mhtracker_proto.quoteApi.model.Quote.class);
    }
